...
TIP: Spring Boot provides various conversion mechanism with advanced value formatting, make sure to review link:https://docs.spring.io/spring-boot/docs/2.7.x/reference/htmlsingle/#features.external-config.typesafe-configuration-properties.conversion[the properties conversion section].
